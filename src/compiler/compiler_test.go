	...
	tests := []compilerTestCase{
		...
		//},
		{
			...
			expectedConstants: []interface{}{
				55, 66, 77, 88,
				[]code.Instructions{
					code.Make(code.OpConstant, 3),  // set const c=88
					code.Make(code.OpSetLocal, 0),  // put c to local stack
					code.Make(code.OpGetGlobal, 0), // put global to local stack
					code.Make(code.OpGetFree, 0),   // get free variable a to local stack
					code.Make(code.OpAdd),
